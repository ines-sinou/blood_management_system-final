            ...
            <div class="card shadow-lg border-0 rounded-4 p-4">
              ...
              <div class="d-flex justify-content-center align-items-end mb-4 podium">
                ...
                <div class="text-center me-3">
                  <div class="bg-secondary text-dark rounded-3 px-3 py-3 mb-5 ines-podium-box" style="height:80px;">
                ...
                <div class="text-center">
                  <div class="bg-warning ines-text-maroon rounded-3 px-3 py-4 mb-5 ines-podium-box" style="height:100px;">
                ...
                <div class="text-center ms-3">
                  <div class="bg-danger text-dark rounded-3 px-3 py-3 mb-5 ines-podium-box" style="height:70px;">
...
<section class="ines-content-section" id="profile">
  <div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <h3 class="fw-bold ines-text-maroon">
        <i class="fas fa-user me-2 text-danger"></i>Your Profile
      </h3>
    </div>
    ...
    <div class="row g-4">
      ...
      <div class="col-lg-4">
        <div class="card shadow-sm rounded-4 p-4 text-center">
          <img src="assets/profile.webp" class="rounded-circle border border-3 border-danger mb-3" width="140" height="140" alt="Profile">
          <h5 class="fw-bold mb-1">Sinou Ines</h5>
          <small class="text-muted mb-3 d-block">Silver Donor</small>

          <div class="mb-3">
            <p class="mb-1"><i class="fas fa-envelope me-2 text-danger"></i>ines@example.com</p>
            <p class="mb-1"><i class="fas fa-phone me-2 text-danger"></i>+237 6XX XXX XXX</p>
            <p class="mb-0"><i class="fas fa-map-marker-alt me-2 text-danger"></i>Yaoundé, Cameroon</p>
          </div>

          <button class="btn btn-danger mt-3 w-100" data-bs-toggle="modal" data-bs-target="#editProfileModal">
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm rounded-4 p-4">
          <h5 class="fw-bold text-danger mb-4"><i class="fas fa-user-edit me-2"></i>Profile Details</h5>
          <form>
            <div class="row g-3">
              <div class="col-md-6">
                <label for="firstName" class="form-label">First Name</label>
                <input type="text" class="form-control" id="firstName" value="Sinou">
              </div>
              <div class="col-md-6">
                <label for="lastName" class="form-label">Last Name</label>
                <input type="text" class="form-control" id="lastName" value="Ines">
              </div>
              <div class="col-md-6">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" value="ines@example.com">
              </div>
              <div class="col-md-6">
                <label for="phone" class="form-label">Phone</label>
                <input type="text" class="form-control" id="phone" value="+237 6XX XXX XXX">
              </div>
              <div class="col-md-12">
                <label for="location" class="form-label">Location</label>
                <input type="text" class="form-control" id="location" value="Yaoundé, Cameroon">
              </div>
            </div>
            <div class="mt-4">
